...
A **package manager** is a tool in Linux that helps you:
...
👉 In simple words:  
**It does all the hard work of installing and managing software for you.**

##  How Does a Package Manager Work?

###  Repositories (Repos)

- Repositories are **online storage places** where software is kept  
- Your system downloads software from these  

👉 Example: Ubuntu uses `archive.ubuntu.com`

###  Installing Software

When you install something:

- ✅ It downloads the software  
- ✅ Installs required dependencies (extra packages)  
- ✅ Sets everything up automatically  

👉 You don’t need to install things manually

###  Updating Software

- One command can update **all installed software**
- Keeps your system secure and up to date  

### Removing Software

- Removes software **completely**
